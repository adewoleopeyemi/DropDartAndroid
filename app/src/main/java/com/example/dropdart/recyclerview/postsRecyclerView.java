package com.example.dropdart.recyclerview;
...
public class postsRecyclerView extends RecyclerView {
        ...
        // vars
        private ArrayList<ModelPost> mediaObjects = new ArrayList<>();
        ...
        /**public void adjustPositionTopOfScreen(ViewGroup v){
        ...
        public void playVideo(boolean isEndOfList) {
            ...
            postsViewHolder holder = (postsViewHolder) child.getTag();
            if (holder == null) {
                playPosition = -1;
                return;
            }
            frameLayout = holder.itemView.findViewById(R.id.VideoHolder);
            ...
            String mediaUrl = mediaObjects.get(targetPosition).getpVideo();
            if (mediaUrl != null) {
        ...
        public void setMediaObjects(ArrayList<ModelPost> mediaObjects){
